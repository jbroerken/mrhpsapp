...
#ifndef CBClearLaunchSOA_h
#define CBClearLaunchSOA_h
...
class CBClearLaunchSOA : public MRH_Callback
{
public:
    ...
    /**
     *  Perform a callback with a recieved clear launch event.
     *
