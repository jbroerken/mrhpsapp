...
#ifndef CBLaunchSOATimer_h
#define CBLaunchSOATimer_h
...
class CBLaunchSOATimer : public MRH_Callback
{
public:
    ...
    CBLaunchSOATimer(std::shared_ptr<LaunchContainer>& p_Container) noexcept;
    
    /**
     *  Default destructor.
     */
    
    ~CBLaunchSOATimer() noexcept;
    ...
    /**
     *  Perform a callback with a recieved timed launch event.
     *
