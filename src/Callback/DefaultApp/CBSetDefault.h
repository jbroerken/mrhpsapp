...
#ifndef CBSetDefault_h
#define CBSetDefault_h
...
class CBSetDefault : public MRH_Callback
{
public:
    ...
    /**
     *  Perform a callback with a recieved set default app event.
     *
