...
#ifndef CBGetDefault_h
#define CBGetDefault_h
...
class CBGetDefault : public MRH_Callback
{
public:
    ...
    /**
     *  Perform a callback with a recieved get default app event.
     *
